sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/mindsquare/gdmvt/receipt/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.mindsquare.gdmvt.receipt.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/mindsquare/gdmvt/receipt/localService/mockserver"], function (mockserver) {
